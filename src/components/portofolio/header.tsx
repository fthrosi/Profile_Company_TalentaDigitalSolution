...
export default function Header() {
  ...
  return (
    <div
      className="relative h-[46rem] sm:h-[38rem] md:h-[34rem] lg:h-[28.3rem] xl:h-[28rem] bg-[url('/assets/icons/Main.png')] bg-no-repeat bg-cover flex flex-col items-center justify-center py-10 xl:py-20"
      ref={parallaxRef1}
    >
      <img
      ...
      />
      <div className="md:z-10 px-[clamp(0.5rem,5vw,2rem)] md:px-[clamp(3rem,3vw,3.5rem)] xl:px-[clamp(6rem,10vw,9rem)] 2xl:px-0 2xl:max-w-[1440px] 2xl:mx-auto">
        <div className="w-full max-w-7xl flex flex-col xl:flex-row mt-20 md:mt-10 lg:mt-0 md:gap-5 lg:gap-3 xl:gap-10">
          ...
          <div className="flex items-center">
            <p className="text-white font-cabin text-justify text-base xl:text-lg">
              ...
              responsif, fungsional, dan user-friendly. Percayakan proyekmu
              kepada tim profesional kami dan buat brand-mu semakin bersinar di
              dunia digital
            </p>
          </div>
        </div>
        {/* <div className="w-full flex flex-wrap lg:flex-nowrap md:flex-row gap-4 mt-6 lg:mt-8 xl:mt-10 justify-center text-base">
          ...
          <div className="bg-white rounded-md p-1 flex w-full sm:w-fit items-center gap-2 min-w-fit">
            <img
              src="/assets/icons/kustmisasi.png"
              alt=""
              className="w-auto h-auto"
            />
            <h2 className="text-blue-800 font-semibold whitespace-nowrap">
          ...
          <div className="bg-white rounded-md p-1 flex w-full sm:w-fit items-center gap-2 min-w-fit">
            <img
              src="/assets/icons/teknologi.png"
              alt=""
              className="w-auto h-auto"
            />
            <h2 className="text-blue-800 font-semibold whitespace-nowrap">
