...
const Card: React.FC<cardProps> = ({ judul, isi, img }) => {
  return (
    <div className="flex flex-col items-center 2xl:w-[38vw] mb-12 md:mb-28 lg:w-[39.09vw] bg-white rounded-4xl overflow-hidden box-shadow">
      <div className="w-full px-5 pb-2 pt-5 h-1/3">
